...
function calcularSoma(matriz){
    ...
    for(let linha = 0; linha < TAMANHOMATRIZ; linha++){
        for(let coluna = 0; coluna < TAMANHOMATRIZ; coluna++){
            if(linha < coluna && linha + coluna < TAMANHOMATRIZ - 1){
...
function calcularQtdeNumeros(ordem){ // em uma area da matriz dividida em 4 partes pelas diagonais
    let qtde = (ordem * (ordem - 2) / 4);
    return qtde;
} 
